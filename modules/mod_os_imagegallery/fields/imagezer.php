...
class JFormFieldImagezer extends JFormField {
    ...
    protected function _build($moduleID, $name, $value) {
        ...
        $document->addStyleSheet(JURI::root() . "modules/mod_OS_ImageGallery/assets/css/jquery-ui-1.10.3.custom.min.css");
        $document->addStyleSheet(JURI::root() . "modules/mod_OS_ImageGallery/assets/css/fileuploader.css");
        $document->addStyleSheet(JURI::root() . "modules/mod_OS_ImageGallery/assets/css/admin_style.css");
        $document->addStyleSheet(JURI::root() . "modules/mod_OS_ImageGallery/assets/css/basic.css");
        if(version_compare(JVERSION, "3.2.0",'lt')) {
            $document->addScript(JURI::root() . "modules/mod_OS_ImageGallery/assets/js/jquery-1.7.1.min.js");
        }
        $document->addScript(JURI::root() . "modules/mod_OS_ImageGallery/assets/js/base64.js");
        $document->addScript(JURI::root() . "modules/mod_OS_ImageGallery/assets/js/fileuploader.js");
        $document->addScript(JURI::root() . "modules/mod_OS_ImageGallery/assets/js/jquery-ui-1.10.3.custom.min.js");
        ?>
        ...
        $document->addScript(JURI::root() . "modules/mod_OS_ImageGallery/assets/fileuploader/fileuploader.min.js");
        $document->addStyleSheet(JURI::root() . "modules/mod_OS_ImageGallery/assets/fileuploader/fileuploader.css");
        ...
        $html = '
			...
			<div id="btss-file-uploader">		
                <noscript>
					<p>' . JText::_('mod_OS_ImageGallery_NOTICE_JAVASCRIPT') . '</p>
				</noscript>         
			</div>
        ...
        <script language="JavaScript">
            (function($) {
                ...
                var uploader = new qq.FileUploader({
                    ...
                    action: '<?php echo JURI::root() . "modules/mod_OS_ImageGallery/file_uploader/uploader.php"; ?>',
                    params: {
