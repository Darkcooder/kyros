...
<div class="jlslogin">
<?php
$doc->addStyleSheet(JURI::root().'modules/mod_slogin/tmpl/'.$layout.'/menu.css');
$doc->addStyleSheet(JURI::root().'modules/mod_slogin/tmpl/'.$layout.'/logout.css');
    ...
    <?php if (!empty($avatar)) : ?>
        <div class="logout-avatar">
			<a href="<?php echo $profileLink; ?>" target="_blank">
				<img src="<?php echo $avatar; ?>" id="avatar" alt=""/>
			</a>
        </div>
        ...
        <form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form">
			...
			<?php	if ($params->get('slogin_link_auch_edit', 1) == 1) {?>
				<li><a href="<?php echo $profileLink; ?>"><?php echo JText::_(htmlspecialchars($user->get('name'))); ?></a>
                ...
                <img src="/images/icons/16/menu.png" id="menuIcon" alt="Меню" />
			<?php }	?><?php echo JHtml::_('form.token'); ?>
		    </ul></form>

        </div>
        <ul class="hidden" id="mainMenu"></ul>
    <?php endif; ?>
...
<div class="logout-avatar">
    <a href="/component/slogin/provider/vkontakte/auth"><img src="/images/auth.gif" id="avatar" alt="" /></a>
</div>
