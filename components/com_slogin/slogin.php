...
if(JFactory::getApplication()->getUserState('vk.app')==1&&$task=="check") {
    JFactory::getApplication()->setUserState('vk.app', 0);
    //$app->redirect("https://intent.guide/vk");
}
if($app->input->get("api_id")=="5335638")JFactory::getApplication()->setUserState('vk.app', 1);
