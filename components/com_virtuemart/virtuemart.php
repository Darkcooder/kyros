...
include (JPATH_ROOT.DS.'components'.DS.'com_virtuemart'.DS.'kint-master'.DS.'Kint.class.php');
...
if(VmConfig::get('shop_is_offline',0)){
	...
	$_controller = vRequest::getCmd('controller', vRequest::getCmd('view', 'virtuemart')) ;
