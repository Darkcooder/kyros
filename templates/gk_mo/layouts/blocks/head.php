...
if(!file_exists(JPATH_SITE.DS.'components'.DS.'com_k2'.DS.'helpers'.DS.'route.php')) {
  ...
  $this->API->addJS('//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js');
}
...
<script type="text/javascript" src="<?php echo $this->API->URLtemplate() . '/js/ie9.js'; ?>"></script>
<![endif]-->
