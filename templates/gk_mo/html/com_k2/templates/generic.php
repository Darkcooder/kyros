...
<section id="k2Container" class="genericView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
          ...
          <div class="itemList">
                    ...
                    <article<?php if($this->params->get('genericItemImage') && !empty($item->imageGeneric)): echo ' class="has-image"'; endif; ?>>
                              <?php if($this->params->get('genericItemImage') && !empty($item->imageGeneric)): ?>
                              <div class="itemImageBlock"> <a class="itemImage" href="<?php echo $item->link; ?>" title="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>">
                              ...
                              <ul class="itemAsideInfo">
                                        ...
                                        <li class="itemDate">
                                                  <time datetime="<?php echo JHtml::_('date', $item->created, 'Y-m-d'); ?>"> <?php echo JHTML::_('date', $item->created , 'jS'); ?> <span><?php echo JHTML::_('date', $item->created , 'M'); ?></span> </time>
                                        </li>
                                        <?php endif; ?>
                                        <?php if($this->params->get('genericItemCategory')): ?>
                                        <li class="itemCategory"> <span><?php echo JText::_('TPL_GK_LANG_PUBLISHED_IN'); ?></span> <a href="<?php echo $item->category->link; ?>"><?php echo $item->category->name; ?></a> </li>
                                        <?php endif; ?>
                              </ul>
                              <?php endif; ?>
                              <div class="itemBody">
