      	...
      	<?php foreach ($block->items as $itemCounter=>$item): K2HelperUtilities::setDefaultImage($item, 'latest', $this->params); ?>
      		<?php if($itemCounter==0): ?>
      			<?php 
      				...
      				if($this->params->get('latestItemsCols') == 4) {
                echo $this->loadTemplate('item_4');   
              } elseif($this->params->get('latestItemsCols') == 3) {
      					echo $this->loadTemplate('item_3'); 	
      				} elseif($this->params->get('latestItemsCols') == 2) {
      					echo $this->loadTemplate('item_2'); 	
      				} elseif($this->params->get('latestItemsCols') == 1) {
