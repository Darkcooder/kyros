          ...
          <div class="itemBlock">
                    ...
                    <ul class="itemAsideInfo">
                              ...
                              <li class="itemComments">
                                        ...
                                        <?php else: ?>
                                        <a href="<?php echo $this->item->link; ?>#itemCommentsAnchor"> <?php echo '0 ' . JText::_('K2_COMMENTS'); ?> </a>
                                        <?php endif; ?>
                                        <?php endif; ?>
                              </li>
                              <?php endif; ?>
                              <?php if($this->item->params->get('catItemHits')): ?>
                              <li class="itemHitsBlock"> <span><?php echo JText::_('K2_READ'); ?></span> <?php echo $this->item->hits; ?> <?php echo JText::_('K2_TIMES'); ?> </li>
                              <?php endif; ?>
                    ...
                    <div class="itemBody">
                              ...
                              <?php endif; ?>
                              <?php echo $this->item->event->AfterDisplayContent; ?> <?php echo $this->item->event->K2AfterDisplayContent; ?> </div>
