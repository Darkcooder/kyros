...
<article class="itemView<?php if($this->item->params->get('latestItemImage') && !empty($this->item->image)): echo ' has-image'; endif; ?> clearfix"> 
     ...
     <?php echo $this->item->event->K2BeforeDisplay; ?>
          ...
          <ul class="itemAsideInfo">
                    ...
                    <li class="itemDate">
                              <time datetime="<?php echo JHtml::_('date', $this->item->created, JText::_(DATE_W3C)); ?>"> <?php echo JHTML::_('date', $this->item->created , 'jS'); ?> <span><?php echo JHTML::_('date', $this->item->created , 'M'); ?></span> </time>
                    </li>
                    <?php endif; ?>
                    <?php if($this->item->params->get('latestItemCategory')): ?>
                    <li class="itemCategory"> <span><?php echo JText::_('TPL_GK_LANG_PUBLISHED_IN'); ?></span> <a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a> </li>
                    <?php endif; ?>
                    ...
                    <li class="itemComments">
                              ...
                              <?php else: ?>
                              <a href="<?php echo $this->item->link; ?>#itemCommentsAnchor"> 0 <?php echo JText::_('K2_COMMENTS'); ?> </a>
                              <?php endif; ?>
                              <?php endif; ?>
                    </li>
                    <?php endif; ?>
          ...
          <div class="itemBody">
                    ...
                    <div class="itemVideoBlock">
                              ...
                              <span class="itemVideo<?php if($this->item->videoType=='embedded'): ?> embedded<?php endif; ?>"><?php echo $this->item->video; ?></span> </div>
                    <?php endif; ?>
                    ...
                    <a class="readon" href="<?php echo $this->item->link; ?>"> <?php echo JText::_('K2_READ_MORE'); ?> </a>
                    <?php endif; ?>
          </div>
