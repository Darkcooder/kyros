...
<section id="k2Container" class="genericView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
          ...
          <section class="itemList">
                    ...
                    <article class="itemView<?php if($item->params->get('genericItemImage') && !empty($item->imageGeneric)): echo ' has-image'; endif; ?>">
                              ...
                              <ul class="itemAsideInfo">
                                        ...
                                        <li class="itemDate">
                                                  <time datetime="<?php echo JHtml::_('date', $item->created, JText::_(DATE_W3C)); ?>"> <?php echo JHTML::_('date', $item->created , 'jS'); ?> <span><?php echo JHTML::_('date', $item->created , 'M'); ?></span> </time>
                                        </li>
                                        <?php endif; ?>
