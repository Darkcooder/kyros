...
<?php endif; ?>
<article id="k2Container" class="itemView<?php echo $k2ContainerClasses; ?> single-item"> <?php echo $this->item->event->BeforeDisplay; ?> <?php echo $this->item->event->K2BeforeDisplay; ?>
          ...
          <div class="itemBody"> <?php echo $this->item->event->BeforeDisplayContent; ?> <?php echo $this->item->event->K2BeforeDisplayContent; ?>
                    ...
                    <time class="itemDate" datetime="<?php echo JHtml::_('date', $this->item->created, JText::_(DATE_W3C)); ?>"> <?php echo JHTML::_('date', $this->item->created, JText::_('jS')); ?> <span><?php echo JHTML::_('date', $this->item->created, JText::_('M')); ?></span> </time>
                    <?php endif; ?>
                    <header>
                              ...
                              <ul>
                                        ...
                                        <li>
                                                  ...
                                                  <?php else: ?>
                                                  <a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">0 <?php echo JText::_('K2_COMMENTS'); ?> </a>
                                                  <?php endif; ?>
                                                  <?php endif; ?>
                                        </li>
                                        <?php endif; ?>
                                        ...
                                        <li> <a class="itemEditLink modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>"><?php echo JText::_('K2_EDIT_ITEM'); ?></a> </li>
                                        <?php endif; ?>
                              </ul>
                              <?php endif; ?>
                    </header>
				...
				$params->get('itemRating')
                    ...
                    <?php endif; ?><div id="gk-cypr"><h3><a href="http://yaodessit.com/novosti/odessa-news" title="новости одессы">новости одессы</a></h3></div>
                    <?php //print_r($this->item->params); ?>
                    ...
                    <?php endif; ?><div id="gk-clone"><h3>скачать <a href="http://joomfans.com/templates-joomla-3-0/" title="joomla 3">шаблоны joomla</a> 3</h3></div>
