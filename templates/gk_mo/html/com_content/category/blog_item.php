...
<article<?php  if (isset($images->image_fulltext) and !empty($images->image_fulltext)) : ?> class="has-image"<?php endif; ?>>
	<?php  if (isset($images->image_fulltext) and !empty($images->image_fulltext)) : ?>
	<div class="itemImageBlock img-full-<?php echo $images->float_fulltext ? $images->float_fulltext : $params->get('float_fulltext'); ?>">
		<img
	...
	<?php if (($params->get('show_author')) or ($params->get('show_category')) or ($params->get('show_create_date')) or ($params->get('show_modify_date')) or ($params->get('show_publish_date')) or ($params->get('show_parent_category')) or ($params->get('show_hits')) or ($params->get('show_create_date'))) : ?>
	 <ul class="itemAsideInfo">
		...
		<li class="itemDate"><time pubdate="<?php echo JHtml::_('date', $this->item->publish_up, JText::_(DATE_W3C)); ?>"><?php echo JHtml::_('date', $this->item->publish_up, JText::_('jS')); ?><span><?php echo JHtml::_('date', $this->item->publish_up, JText::_('M')); ?></span></time></li>
		<?php elseif ($params->get('show_modify_date')) : ?>
		<li class="itemDate"><time pubdate="<?php echo JHtml::_('date', $this->item->modified, JText::_(DATE_W3C)); ?>"><?php echo JHtml::_('date', $this->item->modified, JText::_('jS')); ?><span><?php echo JHtml::_('date', $this->item->modified, JText::_('M')); ?></span></time></li>
		<?php elseif ($params->get('show_create_date')) : ?>
		<li class="itemDate"><time pubdate="<?php echo JHtml::_('date', $this->item->created, JText::_(DATE_W3C)); ?>"><?php echo JHtml::_('date', $this->item->created, JText::_('jS')); ?><span><?php echo JHtml::_('date', $this->item->created, JText::_('M')); ?></span></time></li>
		<?php endif; ?>
