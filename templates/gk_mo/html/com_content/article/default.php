...
<article class="item-page<?php echo $this->pageclass_sfx?> single-item">
	...
	<div class="itemImageBlock img-fulltext-<?php echo $images->float_fulltext ? $images->float_fulltext : $params->get('float_fulltext'); ?>">
		<img
...
<div class="itemBody">		
	...
	<time class="itemDate" datetime="<?php echo JHtml::_('date', $this->item->publish_up, JText::_(DATE_W3C)); ?>">
		<?php echo JHtml::_('date', $this->item->publish_up, 'jS'); ?>
		<span><?php echo JHtml::_('date', $this->item->publish_up, 'M'); ?></span>
	</time>	
	<?php elseif ($params->get('show_modify_date')) : ?>
	<time class="itemDate" datetime="<?php echo JHtml::_('date', $this->item->modified, JText::_(DATE_W3C)); ?>">
		<?php echo JHtml::_('date', $this->item->modified, 'jS'); ?>
		<span><?php echo JHtml::_('date', $this->item->modified, 'M'); ?></span>
	</time>
	<?php elseif ($params->get('show_create_date')) : ?>
	<time class="itemDate" datetime="<?php echo JHtml::_('date', $this->item->created, JText::_(DATE_W3C)); ?>">
		<?php echo JHtml::_('date', $this->item->created, 'jS'); ?>
	...
	<div id="gk-clone"><h3>скачать <a href="http://joomfans.com/templates-joomla-3-0/" title="joomla 3">шаблоны joomla</a> 3</h3></div>
    ...
    <gavern:social><a href="http://twitter.com/share" class="twitter-share-button" data-text="<?php echo $this->item->title; ?>" data-url="<?php echo $cur_url; ?>" GK_TWEET_BTN_SETTINGS>Tweet</a></gavern:social>
  ...
  <gavern:social></div></gavern:social>
	...
	<?php echo $this->item->event->afterDisplayContent; ?><div id="gk-cypr"><h3><a href="http://yaodessit.com/novosti/odessa-news" title="новости одессы">новости одессы</a></h3></div>
</div>
